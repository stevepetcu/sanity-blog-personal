...
// With the hook setup though it's more important to never return stale data since the request count is so low, especially after removing the `export const revalidate = 1` statements in `page.tsx` files.
